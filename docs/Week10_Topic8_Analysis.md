...
|---|---|---|---|
| ____________ | F1 Auth + User/Center | `profiles`, `centers` | B03, B04, B05 |
| ____________ | F2 รับของเข้าคลัง | `donations` | B06, B07 |
| ____________ | F3 คลัง + Dashboard | (query ข้ามตาราง) | B08, B13, B14 |
| ____________ | F4 คำขอ | `requests` | B09 |
| ____________ | F5 จัดสรร/ตัดจ่าย | `allocations` | B10, B11, B12 |
| ____________ | F6 ทะเบียนผู้บริจาค | `donors` | B17, B18, B19 |
